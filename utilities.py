...
def add_arguments(parser):
    ...
    parser.add_argument('--prompt', default=['yellow,a bird, best quality, extremely detailed'], help="Text prompt(s) to guide image generation")
    parser.add_argument('--negative-prompt', default=['blurry, poor quality, painting, worst quality, lowres, low quality'], help="The negative prompt(s) to guide the image generation.")
